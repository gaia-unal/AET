        ...
        <div class="row" style="margin-top: -30px">
            ...
            <center><h2 style="margin-left: 10px;">La evaluación ha terminado</h2></center>
                ...
                <h3 style="text-align: justify; padding:20px">
                    Los resultados presentados a continuación, fueron obtenidos después de haber aplicado la metodológía de valuación de accesibilidad.
                </h3>
                <div class="table-responsive" style="width: 500px;">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr style="background-color:#33A2FD; color:#000">  
                            ...
                            <tr style="background-color:#0f436f; color:#fff">
                ...
                <h2 style="margin-top:-10px">
                    ...
                    <div class="row" style="margin-top: -20px; padding-bottom: 20px">
                        <div class="col-md-6">
                            ...
                            <a href="report.php?val=<?php echo $url?>"><input name="Imprimir" type="submit" id="Imprimir" value="Ver reporte" /></a>
                        </div>
                        <div class="col-md-6">
                            <h3 style="text-align: justify; padding:20px">
